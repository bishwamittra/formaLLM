...
comment="comment="2025_03_13_counterfactural_memorization_fine_tuning""
...
do
    ...
    # for grammar_name in "pcfg_cfg3b_eq_len_uniform_prob_counterfactual"
    for grammar_name in "pcfg_cfg3b_eq_len_skewed_prob_0.90_counterfactual"
