...
workdir="/NS/formal-grammar-and-memorization/work/bghosh/formal_grammars/grammar_learning/read_output"
cd $workdir
nvidia-smi



time TRANSFORMERS_VERBOSITY=error python recollection_vs_contextual_memorization.py