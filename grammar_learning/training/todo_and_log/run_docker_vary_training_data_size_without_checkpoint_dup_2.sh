...
#SBATCH --exclude=sws-8h100grid-05,sws-8h100grid-04,sws-8a100-04
...
formal_grammar_docker bash training/todo_and_log/run_docker_vary_training_data_size_without_checkpoint_dup_2_todo.sh