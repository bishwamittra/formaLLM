...
#SBATCH --exclude=sws-8h100grid-01,sws-8h100grid-02,sws-8h100grid-03,sws-8h100grid-05,sws-8h100grid-07
...
-v /NS/llm-1/nobackup/soumi:/home/exp/training/base_models_soumi \
-v /NS/llm-1/nobackup/vnanda/llm_base_models:/home/exp/training/base_models_vnanda \
--shm-size 128gb \
-e HF_HUB_CACHE=/home/exp/.hf_cache/hub \
formal_grammar_docker bash training/todo_and_log/todo_vary_training_data_size_without_checkpoint_docker_partial_training.sh