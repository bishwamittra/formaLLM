...
# train on a skewed language, and see how well it generalizes to a uniform language. Consider memorization based intervention as well
comment="2025_09_16_memorization_based_intervention_uniform_ood_fine_tuning"
...
do
    ...
    do
        ...
        for grammar_name in "pcfg_cfg3b_eq_len_skewed_prob_uniform_ood"
        do
