...
#SBATCH --exclude=sws-8h200grid-01,sws-8h200grid-03,sws-8h200grid-04
...
formal_grammar_docker bash training/todo_and_log/run_docker_vary_training_data_size_without_checkpoint_dup_19_todo.sh