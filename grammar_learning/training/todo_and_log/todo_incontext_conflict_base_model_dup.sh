...
nvidia-smi
    ...
    comment=f"Week_2025.02_05_edit_distance_results_ft_G1_icl_G1_test_G104_0"
    ...
    do
        ...
        for grammar_name in pcfg_cfg3b_disjoint_terminals_four_rules_different    
        do
    ...
    comment=f"Week_2025.02_05_edit_distance_results_ft_G1_icl_G1_test_G105_0"
    ...
    do
        ...
        for grammar_name in pcfg_cfg3b_disjoint_terminals_five_rules_different    
        do
