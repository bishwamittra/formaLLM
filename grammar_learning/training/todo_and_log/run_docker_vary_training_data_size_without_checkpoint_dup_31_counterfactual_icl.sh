...
# SBATCH --exclude=sws-8h200grid-03,sws-8h200grid-06
...
formal_grammar_docker bash training/todo_and_log/run_docker_vary_training_data_size_without_checkpoint_dup_31_counterfactual_icl_todo.sh



# -e HUGGINGFACE_HUB_TOKEN=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 \
