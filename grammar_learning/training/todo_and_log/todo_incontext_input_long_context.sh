...
#SBATCH --exclude=sws-8h100grid-03,sws-8h100grid-02,sws-8h100grid-01,sws-8h100grid-04
...
#     for considered_incontext_examples in "0" "5" "200"
#     do
...
do
    ...
    for considered_incontext_examples in "1536" "2048" "2560" "3072" "3584" "4096"
    do

        for model_name in "Qwen/Qwen2.5-14B" \
