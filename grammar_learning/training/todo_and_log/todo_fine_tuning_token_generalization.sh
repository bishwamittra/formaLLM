...
comment="2025_09_15_fine_tuning_token_generalization"
...
do
    ...
    do
        ...
        for grammar_name in "pcfg_cfg3b_disjoint_terminals_token_generalization" \
                            "pcfg_4_3_1_2_3_4_5_6_7_8_9_token_generalization"
