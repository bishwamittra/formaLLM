...
do
    ...
    do
        ...
        for grammar_name in "pcfg_cfg3b_eq_len_uniform_prob" "pcfg_cfg3b_eq_len_skewed_prob" "pcfg_cfg3b_eq_len_skewed_prob_0.75" "preg_alphabet_2" "preg_alphabet_7" "preg_alphabet_26"
        do
