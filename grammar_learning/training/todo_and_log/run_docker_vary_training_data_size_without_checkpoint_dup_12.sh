...
#SBATCH --exclude=sws-8h100grid-01,sws-8h100grid-02,sws-8h100grid-03,sws-8h100grid-05
...
formal_grammar_docker bash training/todo_and_log/run_docker_vary_training_data_size_without_checkpoint_dup_12_todo.sh