...
docker run --rm \
--gpus all \
-e HF_TOKEN=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 \
...
formal_grammar_docker bash training/todo_and_log/run_docker_vary_training_data_size_without_checkpoint_dup_30_todo.sh